                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form class="needs-validation" novalidate action="classupdate" method="POST">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom01" placeholder="Class code" name="code" value="${requestScope.classes.class_code}" maxlength="10" required>
...
<!--                                                        <option  value ="" hidden>Select Subject</option>-->
                                                        <c:forEach items="${requestScope.subjects}" var="s">
                                                            <option 
                                                                <c:if test="${s.subject_id eq param.subject_id}">selected</c:if>
...
<!--                                                        <option value ="" hidden>Select Trainer</option>-->
                                                        <c:forEach items="${requestScope.trainers}" var="t">
                                                            <option <c:if test="${param.trainer_id eq t.user_id}">selected</c:if>
...
<!--                                                        <option  value ="" hidden>Select Supporter</option>-->
                                                        <c:forEach items="${requestScope.supporters}" var="sp">
                                                            <option <c:if test="${param.supporter_id eq sp.user_id}">selected</c:if>
...
<!--                                                        <option value ="" hidden>Select Term</option>-->
                                                        <c:forEach items="${requestScope.settings}" var="st">
                                                            <option <c:if test="${param.setting_id eq st.setting_id}">selected</c:if>
...
<!--                                                        <option value =""  hidden>Select Status</option>-->
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="validationCustom07" name="description" maxlength="500" value="${requestScope.classes.description}"></textarea>
                                                </div>
                                                <div class="invalid-feedback">
                                            ...
                                            <input hidden value ="${requestScope.classes.class_id}" type="text" class="form-control" name="class_id" required>
                                            <div class="col-12">
