                            ...
                            <div class="profile-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ml-md-n2 profile-user-info">
                                        <h4 class="user-name mb-0">${sessionScope.user.full_name}</h4>
                                        <h6 class="text-muted">${sessionScope.user.full_name}</h6>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <p class="col-sm-9">${sessionScope.user.full_name}</p>
                                                    </div>                                       
                                                    <div class="row">
